...
public class Method01 {
	...
	public static void add(int a) { //결과물이 없는 매서드 유형. 
		/*
		 * void는 결과물 없음을 의미함.★
		 * add라는 이름을 main메서드 내부 영역에서 호출해야 실행될 코드.
		 * int a 자료를 호출시에 제공해야 내부 문장을 실행할 수 있따.
		 */
		System.out.println(a + 1); //불완전한 코드
	}
	...
	public static void main(String[] args) {
		 ...
		 * 실행 결과물이 있다면 return문을 이용해 약속된 실행결과물을 호출위치로 보내줍니다.
